...
tl2.from(
  ".title1 div, .title1 p, .experience-image-div, .row-margin-top img , .company-content .text,  .company-text",
  {
    y: 100,
    opacity: 0,
    stagger: 0.2,
...
tl5.from(".project-image, .arrow-div", {
  y: 100,
  opacity: 0,
  stagger: 0.1,
  duration: 0.5,
...
tl6.from(
  ".process, .process-content .animated-text, .process-section, .process-step ",
  {
    y: 70,
    opacity: 0,
    stagger: 0.1,
